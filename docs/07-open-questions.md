...
| ~~30 to 50 real bank SMS with personal details removed~~ Done differently: M2b (2026-09-25) analysed a week of real SMS directly instead of a curated sample set - covers ICICI and SBI precisely, plus a generic fallback for other banks. More samples from other banks you use would still sharpen that fallback into precise rules, whenever convenient | Nice-to-have now, not blocking - M2 is fully built | You |
